...
points(YrsPrior[Gender=="Male"],Salary[Gender=="Male"],col="red",pch=19)
points(YrsPrior[Gender=="Female"],Salary[Gender=="Female"],col="blue",pch=19)
