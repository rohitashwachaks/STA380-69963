...
This file is a R Markdown template that you may use to help you generate the file of your final exam. You are not required to write your exam in R Markdown, but it is an easy way to show your R results. 
...
A better option if your simply want the code to run and suppress both the code and the results from the code from appearing in the final file is to use the `include = FALSE` argument. Do not forget that no results will be printed by using this option, so be careful.
